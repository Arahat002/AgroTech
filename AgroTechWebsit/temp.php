...
$sql = "SELECT ROUND(AVG(value1),2) as avg, MIN(value1) as min, MAX(value1) as max FROM Sensor";
$result = $conn->query($sql);
...
$sql = "SELECT ROUND(AVG(value1),2) as avg_1, MIN(value1) as min_1, MAX(value1) as max_1 FROM Sensor WHERE reading_time > NOW() - INTERVAL 1 HOUR";
...
$sql = "SELECT ROUND(AVG(value1),2) as avg_6, MIN(value1) as min_6, MAX(value1) as max_6 FROM Sensor WHERE reading_time > NOW() - INTERVAL 6 HOUR";
...
$sql = "SELECT ROUND(AVG(value1),2) as avg_12, MIN(value1) as min_12, MAX(value1) as max_12 FROM Sensor WHERE reading_time > NOW() - INTERVAL 12 HOUR";
...
$sql = "SELECT ROUND(AVG(value1),2) as avg_24, MIN(value1) as min_24, MAX(value1) as max_24 FROM Sensor WHERE reading_time > NOW() - INTERVAL 24 HOUR";
